...
import de.frontsy.picciotto.converters.poi.BorderUtils;
        ...
        if (rowSpan > 0 || colSpan > 0) {
            ...
            try {
                if (xssfCell != null) {
                    ...
                    //BorderUtils.setBorderTop(xssfSheet, xssfCell.getCellStyle().getBorderTop(), mergedRegion);
                    //BorderUtils.setBorderRight(xssfSheet, xssfCell.getCellStyle().getBorderRight(), mergedRegion);
                    BorderUtils.setBorderBottom(xssfSheet, xssfCell, mergedRegion);
                    //BorderUtils.setBorderLeft(xssfSheet, xssfCell.getCellStyle().getBorderLeft(), mergedRegion);
                    /*
